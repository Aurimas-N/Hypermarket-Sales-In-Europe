...
* Create interactive dashboard in Tableau that shows: KPI's, regions, monthly sales, top selling products,processing time between order and shipment, most profitable item type by country.
